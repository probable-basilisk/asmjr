...
static OPS: phf::Map<&'static str, OpInfo> = phf_map! {
    ...
    "unpki" => OpInfo{opcode: 53, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Im], rel: false},
    "cas" => OpInfo{opcode: 54, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Rs2], rel: false},
    "smprm" => OpInfo{opcode: 55, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Im], rel: false},
    "srprm" => OpInfo{opcode: 56, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Im], rel: false},
    "swprm" => OpInfo{opcode: 57, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Im], rel: false},
    "sxprm" => OpInfo{opcode: 58, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Im], rel: false},
    "abs" => OpInfo{opcode: 59, argct: 2, args: [OpArg::Rd, OpArg::Rs1, OpArg::Void], rel: false},
    "sin" => OpInfo{opcode: 60, argct: 2, args: [OpArg::Rd, OpArg::Rs1, OpArg::Void], rel: false},
    "cos" => OpInfo{opcode: 61, argct: 2, args: [OpArg::Rd, OpArg::Rs1, OpArg::Void], rel: false},
    "atan" => OpInfo{opcode: 62, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Rs2], rel: false},
    "xgath" => OpInfo{opcode: 63, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Rs2], rel: false},
    "xscat" => OpInfo{opcode: 64, argct: 3, args: [OpArg::Rd, OpArg::Rs1, OpArg::Rs2], rel: false},
};
